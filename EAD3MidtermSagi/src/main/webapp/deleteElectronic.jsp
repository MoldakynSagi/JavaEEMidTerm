...
<div class="login-form">
    <div class="well">
        <h3>Delete an Electronic</h3>
        <form action="DeleteElectronicServlet" method="post" align="center">
            <fieldset class="form-group">
                <label>Electronic Id</label>
                <input type="text" class="" placeholder="Enter Electronic ID" name="id" id="id">
            </fieldset>
            <br>
            <button type="submit" name="action" value="update" class="btn btn-success">Add</button>
            <br>
        </form>
    </div>
</div>
